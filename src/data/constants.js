...
export const TEAM = [
  { name: 'Marwa Stephan',    email: 'marwa.stouhi@totersapp.com',    color: '#a855f7' },
  ...
  { name: 'Ahmad Lahham',     email: 'ahmad.lahham@totersapp.com',    color: '#ec4899' },
  ...
  { name: 'Charbel Sassine',  email: 'charbel.sassine@totersapp.com', color: '#f59e0b' },
  ...
  { name: 'Ahmad Ataya',      email: 'ahmad.ataya@totersapp.com',     color: '#ec4899' },
  { name: 'Julian Touma',     email: 'julian.touma@totersapp.com',    color: '#f97316' },
  { name: 'Adnan Diab',       email: 'adnan.diab@totersapp.com',      color: '#a855f7' },
  { name: 'Charles Serhal',   email: 'charles.serhal@totersapp.com',  color: '#3b82f6' },
  { name: 'Ahmad Hamdan',     email: 'ahmad.hamdan@totersapp.com',    color: '#22c55e' },
  ...
  { name: 'Omar Barakat',     email: 'omar.barakat@totersapp.com',    color: '#e8500a' },
];
